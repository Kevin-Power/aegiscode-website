...
const faqs = [
  ...
  },
  {
    ...
    a: "歐盟 CRA（Cyber Resilience Act）的通報義務 2026 年 9 月 11 日生效——被主動利用的漏洞須在 24 小時內早期預警、72 小時內通報；主要義務（機器可讀 SBOM、安全開發與漏洞處理證明）2027 年 12 月全面適用。AegisCode 每次掃描自動產出 CycloneDX／SPDX SBOM 與簽章證據包，已知被利用漏洞情資對應通報觸發判斷；VEX 可利用性聲明（OpenVEX）與 CRA 合規對應報告本季推出。POC 可直接以出口產品的 repo 演練。",
  },
  {
    q: "掃描速度大概需要多久？",
